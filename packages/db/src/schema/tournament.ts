...
import { teamInvitations, users } from "./auth";
...
export const tournament = mySqlTable("tournament", {
  ...
  tournamentDirectorId: int("tournamentDirectorId").notNull(),
});
...
export const pool = mySqlTable("pool", {
...
export const bracket = mySqlTable("bracket", {
